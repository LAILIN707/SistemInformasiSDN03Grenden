                ...
                <div class="col-lg-6">
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" name="nis" id="name" type="text" placeholder="Enter your name..."
                        ...
                        <?php
                            ...
                            if (isset($_POST['Simpan'])){
                                ...
                                $query = mysqli_query($kon, "Insert into absensi_siswa (nis, username, tanggal, keterangan) value ('$nis', '$username', '$tanggal', '$keterangan')");
                                if ($query){
