                ...
                <div class="col-lg-6">
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" name="nip" id="nip" type="text" placeholder="Masukkan Nis Anda......"
                                data-sb-validations="required" />
                            <label for="nip">NIP</label>
                            <div class="invalid-feedback" data-sb-feedback="nip:required">A nip is required.</div>
                        </div>
                        <!-- Input Username -->
                        <div class="form-floating mb-3">
                            <input class="form-control" name="username" id="username" type="text" placeholder="Masukkan Username Anda......"
                        ...
                        <!-- Input Tanggal -->
                        <div class="form-floating mb-3">
                            <input class="form-control" name="tanggal" id="tanggal" type="date" placeholder="(123) 456-7890"
                                data-sb-validations="required" />
                            <label for="tanggal">Tanggal</label>
                            <div class="invalid-feedback" data-sb-feedback="tanggal:required">A tanggal number is required.
                            </div>
                        </div>
                        <!-- Layanan -->
                        <div class="form-floating mb-3">
                        ...
                        <?php
                            ...
                            if (isset($_POST['Simpan'])){
                                ...
                                $query = mysqli_query($kon, "Insert into absensi_tu (nip, username, tanggal, keterangan) value ('$nip', '$username', '$tanggal', '$keterangan')");
                                if ($query){
