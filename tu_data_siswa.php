...
<?php 
    ...
    $query = mysqli_query($kon, "Select * from data_siswa");
?>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    ...
                    <a class="btn btn-primary btn-xl" href="#Data_Siswa">Get Started!</a>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <a class="btn btn-light btn-xl" href="#Data_Siswa">Get Started!</a>
                </div>
            </div>
        </div>
    </section>
    <!-- Data Siswa -->
    <<section class="page-section" id="Data_Siswa">
        <div class="container px-9 px-lg-19">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 col-xl-6 text-center">
                    <h2 class="mt-0">Data Siswa </h2>
                    <hr class="divider" />
                </div>
            </div>
            <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                ...
                <table class="table">
                    ...
                    <?php
                        while($data = mysqli_fetch_array($query)){
                            ...
                            echo "<td><a href ='tu_hapus_data_siswa.php?id=".$data['id']."'>Hapus</td>";
                            echo "<td><a href ='tu_edit_data_siswa.php?id=".$data['id']."'>Edit</td>";
                            echo "</tr>";
                        }
                    ?>
                    </tbody>
                ...
                <div class="col-lg-8 text-center">
                    <a class="btn btn-primary btn-xl" href="tu_tambah_data_siswa.php">Tambah Data</a>
                </div>
            </div>
            <div class="row gx-4 gx-lg-5 justify-content-center">
